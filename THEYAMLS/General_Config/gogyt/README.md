...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **大小** | 35.5 KB | 30.6 KB | 25.5 KB | 26.9 KB | 21.5 KB | 34.3 KB | 26.9 KB | 48.6 KB | 44.1 KB |
...
| **TUN** | 🚫 | 🚫 | 🚫 | 🚫 | 🚫 | 🚫 | 🚫 | 🚫 | 🚫 |
| **策略组** | **91** | **63** | **39** | **59** | **39** | **59** | **63** | **120** | **91** |
| **规则数** | **62** | **32** | **32** | **55** | **32** | **55** | **32** | **62** | **62** |

## 📄 配置详情

#### 📝 GeoAIOPro.yaml
- **路径**: `GeoAIOPro.yaml` | **大小**: 35.5 KB | [查看源码](https://github.com/gogyt/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/gogyt/GeoAIOPro.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
...
#### 📝 GeoAIO.yaml
- **路径**: `GeoAIO.yaml` | **大小**: 26.9 KB | [查看源码](https://github.com/gogyt/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/gogyt/GeoAIO.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
...
#### 📝 RuleAIO.yaml
- **路径**: `RuleAIO.yaml` | **大小**: 34.3 KB | [查看源码](https://github.com/gogyt/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/gogyt/RuleAIO.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
<summary>🔍 策略组 (59个)</summary>
...
#### 📝 RuleAIOPlus.yaml
- **路径**: `RuleAIOPlus.yaml` | **大小**: 48.6 KB | [查看源码](https://github.com/gogyt/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/gogyt/RuleAIOPlus.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
...
#### 📝 RuleAIOPro.yaml
- **路径**: `RuleAIOPro.yaml` | **大小**: 44.1 KB | [查看源码](https://github.com/gogyt/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/gogyt/RuleAIOPro.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
<summary>🔍 策略组 (91个)</summary>
