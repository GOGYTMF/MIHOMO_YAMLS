...
TASKS=$(cat <<'EOF'
https://raw.githubusercontent.com/GOGYTMF/Mihomo/refs/heads/main/yaml/GeoSmartAIO.yaml|THEYAMLS/Smart_Mode/gog-xie/GeoSmartAIO.yaml
https://raw.githubusercontent.com/GOGYTMF/Mihomo/refs/heads/main/yaml/RuleSmartAIO.yaml|THEYAMLS/Smart_Mode/gog-xie/RuleSmartAIO.yaml
